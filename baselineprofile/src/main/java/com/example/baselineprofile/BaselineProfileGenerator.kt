...
class BaselineProfileGenerator {
  ...
  @Test
  fun generate() {
    rule.collect("com.google.android.samples.dynamiccodeloading") {
      ...
      device.waitAndFindObject(By.text("INCREMENT!"), 5000).click()
      device.waitAndFindObject(By.text("SAVE PROGRESS"), 5000).click()
